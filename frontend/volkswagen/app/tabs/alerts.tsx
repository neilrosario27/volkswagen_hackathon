  ...
  const renderAlertItem = ({ item }: { item: Alert }) => (
    <View style={styles.alertCard}>
      <View style={styles.alertHeader}>
        ...
        <Text style={[styles.alertTitle, severityStyle(item.severity)]}>
          {item.title}
        </Text>
      </View>
      ...
      {item.resolvedDate && (
        <Text style={styles.alertResolvedDate}>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyMessage}>No recent alerts</Text>
        }
      />
      ...
      <FlatList
        ...
        keyExtractor={(item) => item.id}
        ListEmptyComponent={
          <Text style={styles.emptyMessage}>No resolved alerts</Text>
        }
      />
    </View>
  );
